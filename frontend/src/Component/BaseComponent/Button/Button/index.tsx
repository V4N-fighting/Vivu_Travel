...
const StyledButton = styled.button<ButtonProps>`
  ...
  &:hover {
    color: ${(props) => (props.disabled ? '#666666' : (props.white ? 'var(--primary-color)' : 'white'))};
  }
  ...
  &::before {
    ...
    opacity: 0;
    content: '';
    background-color: ${(props) => (props.disabled ? 'transparent' : (props.white ? 'white' : 'var(--secondary-color)'))};
    z-index: -2;
  }
