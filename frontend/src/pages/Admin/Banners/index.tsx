...
const Banners: React.FC = () => {
  ...
  return (
    <div>
      ...
      >
        <Form form={form} layout="vertical" initialValues={{ is_active: true, sort_order: 0, page_location: 'home' }}>
          <Form.Item name="page_location" label="Vị trí hiển thị" rules={[{ required: true, message: 'Vui lòng chọn vị trí hiển thị!' }]}>
            <select className="ant-input" style={{ width: '100%', height: '32px', borderRadius: '6px', border: '1px solid #d9d9d9', padding: '4px 11px' }}>
              <option value="home">Trang chủ</option>
              <option value="tours">Trang Tour/Hoạt động</option>
