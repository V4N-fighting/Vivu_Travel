...
import { ContentPadding, Wrapper,Text, FlexBox, Title, Button } from "../../../../styled-components";
import { LogoLink, Logo } from "../../Header/HeaderBottom";
import { SocialIcon } from "../../Header/HeaderBottom/SideMenu";
import { faTwitter, faInstagram, faPinterestP, faFacebook, faFacebookF } from "@fortawesome/free-brands-svg-icons";
import { Icon } from "../../Header/HeaderTop";

const FooterBottomWrapper = styled.div<{url: string}>`
