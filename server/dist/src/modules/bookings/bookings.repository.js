...
let BookingsRepository = class BookingsRepository {
    ...
    async create(bookingData) {
      ...
      `;
            ...
            await client.query(`INSERT INTO payments (booking_id, amount, method, status, paid_at) VALUES ($1, $2, $3, $4, $5)`, [booking.id, totalPrice, paymentMethod, paymentStatus, isOnlinePayment ? new Date() : null]);
