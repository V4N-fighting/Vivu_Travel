...
const groq_travel_service_1 = require("./groq-travel.service");
const recommendation_service_1 = require("./recommendation.service");
let ChatbotService = class ChatbotService {
    constructor(repository, ai, recommendation) {
    ...
    async *stream(request) {
        ...
        try {
            ...
            const updatedMemory = await this.ai.summarizeMemory([...history, { role: 'assistant', content: fullAnswer }], memory);
...
exports.ChatbotService = ChatbotService = __decorate([
    ...
    __metadata("design:paramtypes", [chatbot_repository_1.ChatbotRepository,
        groq_travel_service_1.GroqTravelService,
