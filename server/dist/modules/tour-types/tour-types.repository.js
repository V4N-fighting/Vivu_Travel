...
exports.TourTypesRepository = void 0;
const common_1 = require("@nestjs/common");
const pg_1 = require("pg");
const postgres_provider_1 = require("../../database/postgres.provider");
let TourTypesRepository = class TourTypesRepository {
    constructor(pool) {
        this.pool = pool;
    }
    async findAll() {
...
exports.TourTypesRepository = TourTypesRepository;
exports.TourTypesRepository = TourTypesRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(postgres_provider_1.POSTGRES_POOL)),
    __metadata("design:paramtypes", [pg_1.Pool])
], TourTypesRepository);
//# sourceMappingURL=tour-types.repository.js.map