...
exports.CouponsModule = CouponsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [coupons_service_1.CouponsService, coupons_repository_1.CouponsRepository],
        exports: [coupons_service_1.CouponsService, coupons_repository_1.CouponsRepository],
    })
], CouponsModule);
